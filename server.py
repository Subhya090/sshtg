...
if __name__ == '__main__':
    ...
    dispatcher.add_handler(MessageHandler(filters=filters.all, callback=check_user), group=-1)
    ...
    dispatcher.add_handler(MessageHandler(filters=filters.text, callback=partial(shell, client_holder=client_holder, connection_info=connection_info)))
